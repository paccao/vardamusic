...
<img alt="Sacred Varda Music" src="frontend/src/lib/assets/tree-of-varda.jpeg" width="200"/>
...
```sh
git clone https://github.com/paccao/vardamusic.git && \
cd vardamusic/ && \
pnpm i && \
cd frontend && \
pnpm dev
